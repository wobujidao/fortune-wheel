...
- 🛠️ Toggle-переключатель в шапке админки
...
graph LR
    ...
    E[📱 Telegram API] <-->|webhook / polling| D
...
│   │   └── models.py           # SQLAlchemy-модели (prizes, spins, admins, settings)
│   ├── handlers/
│   │   ├── __init__.py
...
- **busy_timeout 5с** — при блокировке БД запрос ожидает до 30 секунд вместо мгновенной ошибки
